...
import spring.airyny.code.Style;
...
public class StringUtil {
    ...
    public static void main(String[] args){
        String str = "houseInfo";
        //将驼峰风格替换为下划线风格
        String result1 = StringUtil.camelhumpToUnderline(str);
        System.out.println(result1);


        //将下划线风格替换为驼峰风格
        String result2 = StringUtil.underlineToCamelhump(result1.toLowerCase());
